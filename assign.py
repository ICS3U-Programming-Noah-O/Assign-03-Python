...
def main():
    ...
    def units_ft():
        ...
        if package_volume > 328.084 and package_weight_float > weight_num:
            ...
            print(package_volume)
            print("That package is acceptable!")
            print(Fore.YELLOW + "Thank you for choosing Bob’s" +
                  " Box delivery service.")
            print(" ")

    # Prints intro message
    print(Fore.WHITE + "Thank you for using Bob’s Box delivery service.")
    print(Fore.BLUE + "This program can tell you if we are able" +
          " to accept your package for delivery.")
    print(Fore.RED + "We cannot take packages that are over" +
          " 27 kg in weight or 10000 cubic cm in volume.")
    print(" ")
    time.sleep(1)
    unit_volume = (input(Fore.WHITE + "Enter the unit that you" +
                   "would to use to measure the volume cm/mm/ft: "))
    print(" ")
